...
// const cloud = "is_synced_with_cloud";
...
//     }
//     else{
//       final ups = await getNote(id: note.id);
//       _notes.removeWhere((note) => note.id==ups.id);
//       _notes.add(ups);
//       _notesStreamController.add(_notes);
//       return ups;
//     }
...
//     await _ensureDbisOpen();
//     final db = _getDatabaseOrThrow();
//     final nums =  await db.delete(noteTable);
//     _notes = [];
//     _notesStreamController.add(_notes);
//     return nums;
//   }
...
//   text = map[textColumn] as String, isSyncedWithCloud = (map[cloud] as int)==1 ? true :false ;

//   @override
//   String toString() => 'Person, ID = $id, userId= $userId isSyncedWithCloud = $isSyncedWithCloud';
