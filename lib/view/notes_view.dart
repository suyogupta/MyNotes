    ...
    return Scaffold(
        appBar: AppBar(
          ...
          actions: [
            IconButton(
                onPressed: () async {
                  String? gotted = await showTitleDialog(context);
                  log(gotted.toString());
...
Future<String?> showTitleDialog(BuildContext context) {
  return showDialog<String?>(
      ...
      builder: (context) 
      {
        ...
        return AlertDialog(
          title: const Text('New Note File'),
          content: ListView(
            shrinkWrap: true,
            children: [
              TextFormField(
                controller: nameControl,
                decoration: const InputDecoration(hintText: 'Enter a name please'),
              )
            ],
          ),
          actions: [
            ...
            TextButton(
                onPressed: () {
                  Navigator.of(context).pop(nameControl.text);
                },
                child: const Text('OK')),
          ],
        );
